...
class SpacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create space" do
    assert_difference('Space.count') do
      post spaces_url, params: { space: { logo_data: @space.logo_data, name: @space.name, readme: @space.readme } }
    end
  ...
  test "should update space" do
    patch space_url(@space), params: { space: { logo_data: @space.logo_data, name: @space.name, readme: @space.readme } }
